...
import CPSC331Assignment5.lengthOrdering;
 ...
 * longer words before shorter words, and words of the same length
 * in alphabetical order.
 * 
 */

public class wordUsage6
{
    /**
    *
    ...
    public static void main(String[] args)
    {
        if (args.length == 1)
        {
            try
            {
                ...
                lengthOrdering<String, Integer> frequencyOrder
                             = new lengthOrdering<String, Integer>();
